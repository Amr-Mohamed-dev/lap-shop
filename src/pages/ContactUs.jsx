...
const ContactUs = () => {
  ...
  return (
    <div className="pt-24 px-4 bg-white dark:bg-gray-900 h-screen" ref={ref}>
      <h1 className="text-4xl pb-7 font-bold text-center text-gray-900 dark:text-gray-100">
        {translate("ContactUsPage.contactus")}
      </h1>
      <div className="grid sm:grid-cols-2 items-start gap-14 p-8 mx-auto max-w-4xl bg-white dark:bg-gray-900 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md font-[sans-serif]">
        <div>
          <h1 className="text-gray-900 dark:text-gray-100 text-2xl font-extrabold">
            {" "}
          ...
          <div className="mt-12">
            <h2 className="text-gray-900 dark:text-gray-100 text-base font-bold">
              {translate("ContactUsPage.Email")}
            </h2>
            <ul className="mt-4">
              <li className="flex items-center">
                <div className="bg-[#e6e6e6cf] h-10 w-10 rounded-full text-[#007bff] flex items-center justify-center shrink-0">
                  <FaPhoneAlt />
                </div>
                <a
